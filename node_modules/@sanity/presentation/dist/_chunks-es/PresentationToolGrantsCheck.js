...
import { Button, Text, Stack, Inline, Box, Flex, Container as Container$1, Card, Code, Label, ErrorBoundary, Tooltip, TextInput, Spinner, useToast, MenuButton, Menu, Grid, Switch, MenuDivider, MenuItem, Hotkeys, usePrefersReducedMotion, TooltipDelayGroupProvider, BoundaryElementProvider } from "@sanity/ui";
import { uuid } from "@sanity/uuid";
import { memo, useEffect, useRef, createContext, useContext, useLayoutEffect, useState, forwardRef, Suspense, useId, lazy, useMemo, useCallback, createElement, useImperativeHandle, useSyncExternalStore, startTransition, useReducer } from "react";
import { useTranslation, useUnique, getPublishedId, useDocumentPreviewStore, getPreviewStateObservable, useSchema, getPreviewValueWithFallback, SanityDefaultPreview, PreviewCard, Translate, CommentsIntentProvider, useActiveWorkspace, useClient, useCurrentUser, useEditState, useProjectId, useDataset, useWorkspace, useGrantsStore } from "sanity";
...
import { createListenLogic, createRequestMachine, DOMAIN, MSG_HANDSHAKE_SYN, MSG_HANDSHAKE_SYN_ACK, MSG_HANDSHAKE_ACK, MSG_RESPONSE, MSG_HEARTBEAT, MSG_DISCONNECT, createController, createConnectionMachine } from "@sanity/comlink";
import { studioPath } from "@sanity/client/csm";
import { StateLink, useRouter, decodeJsonParams } from "sanity/router";
import { styled } from "styled-components";
import { useEffectEvent } from "use-effect-event";
import { WarningOutlineIcon, LaunchIcon, ResetIcon, ShareIcon, CopyIcon, PanelLeftIcon, EditIcon, PublishIcon, RefreshIcon, ChevronDownIcon, CheckmarkIcon, MobileDeviceIcon, DesktopIcon } from "@sanity/icons";
...
const channelsToComlinkMap = {
  ...
  const {
    channelId,
    ...rest
  } = comlinkMessage, message = {
    ...rest,
    connectionId: channelId
  };
  return message.domain === DOMAIN && (message.domain = "sanity/channels"), message.to === "visual-editing" && (message.to = "overlays"), message.from === "visual-editing" && (message.from = "overlays"), message.type = comlinkToChannelsMap[message.type] ?? message.type, message.type === "channel/response" && message.responseTo && !message.data && (message.data = {
...
const PostMessageFeatures = (props) => {
  ...
  let t0, t1;
  return $[0] !== comlink ? (t0 = () => comlink.on("visual-editing/features", _temp$8), t1 = [comlink], $[0] = comlink, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), useEffect(t0, t1), null;
};
...
const SharedStateProvider = function(props) {
  ...
  const context = t5;
  let t7;
  return $[11] !== children || $[12] !== context ? (t7 = /* @__PURE__ */ jsx(SharedStateContext.Provider, { value: context, children }), $[11] = children, $[12] = context, $[13] = t7) : t7 = $[13], t7;
...
`, Panel = function(t0) {
  const $ = c(15), {
    ...
    maxWidth,
    order: t2
  } = t0, defaultSize = t1 === void 0 ? null : t1, order = t2 === void 0 ? 0 : t2, context = useContext(PanelsContext);
  if (context === null)
...
`, Panels = function(t0) {
  ...
  let t24;
  return $[43] !== context || $[44] !== t23 ? (t24 = /* @__PURE__ */ jsx(PanelsContext.Provider, { value: context, children: t23 }), $[43] = context, $[44] = t23, $[45] = t24) : t24 = $[45], t24;
};
function ErrorCard(props) {
  ...
  let t1;
  $[8] !== onRetry || $[9] !== t0 ? (t1 = /* @__PURE__ */ jsx(Button, { fontSize: 1, mode: "ghost", onClick: onRetry, text: t0 }), $[8] = onRetry, $[9] = t0, $[10] = t1) : t1 = $[10];
  const retryButton = t1;
  let t2;
  $[11] !== t ? (t2 = t("error-card.continue-button.text"), $[11] = t, $[12] = t2) : t2 = $[12];
  let t3;
  $[13] !== onContinueAnyway || $[14] !== t2 ? (t3 = /* @__PURE__ */ jsx(Button, { fontSize: 1, mode: "ghost", tone: "critical", onClick: onContinueAnyway, text: t2 }), $[13] = onContinueAnyway, $[14] = t2, $[15] = t3) : t3 = $[15];
...
function _temp$6() {
  return /* @__PURE__ */ jsx(Fragment, { children: "ParameterizedLink" });
}
...
function DocumentListPane(props) {
  ...
  if ($[0] !== mainDocumentState?.document?._id || $[1] !== refs) {
    let t22;
    $[3] !== mainDocumentState?.document?._id ? (t22 = (r) => getPublishedId(r._id) !== mainDocumentState?.document?._id, $[3] = mainDocumentState?.document?._id, $[4] = t22) : t22 = $[4], t1 = refs.filter(t22).map(_temp$5), $[0] = mainDocumentState?.document?._id, $[1] = refs, $[2] = t1;
  } else
    t1 = $[2];
  t0 = t1;
  const ids = t0;
...
`, PanelResizer = function(t0) {
  const $ = c(27), {
    ...
    order,
    disabled: t1
  } = t0, disabled = t1 === void 0 ? !1 : t1, el = useRef(null), context = useContext(PanelsContext);
  if (context === null)
    throw Error("Panel components must be rendered within a PanelGroup container");
...
function OpenPreviewButton(props) {
  ...
  let t6;
  $[9] !== handleOpenPopup || $[10] !== t4 || $[11] !== t5 ? (t6 = /* @__PURE__ */ jsx(Button, { as: "a", "aria-label": t4, fontSize: 1, icon: LaunchIcon, mode: "bleed", padding: 2, href: t5, onClick: handleOpenPopup, rel: "opener", target: "_blank" }), $[9] = handleOpenPopup, $[10] = t4, $[11] = t5, $[12] = t6) : t6 = $[12];
  let t7;
  return $[13] !== t2 || $[14] !== t6 ? (t7 = /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: t2, fallbackPlacements: t3, padding: 2, placement: "bottom", portal: !0, children: t6 }), $[13] = t2, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
}
...
`, MotionSpinner = motion.create(Spinner), MotionText = motion.create(Text), MotionMonogram = motion.create(StyledSanityMonogram), SharePreviewMenu = memo(function(props) {
  ...
  return useEffect(() => {
  ...
  }, [client]), /* @__PURE__ */ jsx(MenuButton, { button: /* @__PURE__ */ jsx(Button, { "aria-label": t("preview-frame.share-button.aria-label"), fontSize: 1, icon: ShareIcon, mode: "bleed", padding: 2 }), id: "share-menu", menu: /* @__PURE__ */ jsx(Menu, { style: {
    maxWidth: 248
    ...
    /* @__PURE__ */ jsx("label", { style: {
      ...
      }) }), fallbackPlacements: ["bottom-start"], padding: 1, placement: "bottom", portal: !0, children: /* @__PURE__ */ jsx(Switch, { checked: enabling || url !== null && !disabling, readOnly: enabling || disabling, indeterminate: loading, onChange: canToggleSharePreviewAccess ? url ? handleDisableSharing : handleEnableSharing : handleUnableToToggle }) }),
    ...
    /* @__PURE__ */ jsx(MenuItem, { disabled: !url || disabling, icon: CopyIcon, onClick: handleCopyUrl, fontSize: 1, padding: 3, text: t("share-preview-menu.copy-url.text") })
...
const PERSPECTIVE_TITLE_KEY = {
  ...
  let t5;
  $[9] !== navigatorEnabled || $[10] !== t || $[11] !== toggleNavigator ? (t5 = toggleNavigator && /* @__PURE__ */ jsx(Box, { flex: "none", marginRight: 1, padding: 1, children: /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: /* @__PURE__ */ jsx(Text, { size: 1, children: t("preview-frame.navigator.toggle-button.tooltip") }), fallbackPlacements: ["bottom-start"], padding: 2, placement: "bottom", portal: !0, children: /* @__PURE__ */ jsx(Button, { "aria-label": t("preview-frame.navigator.toggle-button.aria-label"), fontSize: 1, icon: PanelLeftIcon, mode: "bleed", onClick: toggleNavigator, padding: 2, selected: navigatorEnabled }) }) }), $[9] = navigatorEnabled, $[10] = t, $[11] = toggleNavigator, $[12] = t5) : t5 = $[12];
  let t6;
  ...
  let t9;
  $[17] !== t8 ? (t9 = /* @__PURE__ */ jsx(Box, { padding: 1, children: /* @__PURE__ */ jsx(Text, { size: 1, children: t8 }) }), $[17] = t8, $[18] = t9) : t9 = $[18];
  let t10;
  $[19] === Symbol.for("react.memo_cache_sentinel") ? (t10 = /* @__PURE__ */ jsx(Box, { paddingY: 1, children: /* @__PURE__ */ jsx(Hotkeys, { keys: ["Alt"], style: {
    marginTop: -4,
    marginBottom: -4
  } }) }), $[19] = t10) : t10 = $[19];
  let t11;
  $[20] !== t9 ? (t11 = /* @__PURE__ */ jsxs(Flex, { align: "center", style: t6, children: [
    t9,
    t10
  ] }), $[20] = t9, $[21] = t11) : t11 = $[21];
  let t12;
  ...
  let t17;
  $[25] !== overlaysEnabled || $[26] !== t16 || $[27] !== toggleOverlay ? (t17 = /* @__PURE__ */ jsx("div", { style: t15, children: /* @__PURE__ */ jsx(Switch, { checked: overlaysEnabled, onChange: toggleOverlay, disabled: t16 }) }), $[25] = overlaysEnabled, $[26] = t16, $[27] = toggleOverlay, $[28] = t17) : t17 = $[28];
  const t18 = !overlaysEnabled;
  let t19;
  $[29] !== t ? (t19 = t("preview-frame.overlay.toggle-button.text"), $[29] = t, $[30] = t19) : t19 = $[30];
  let t20;
  $[31] !== t18 || $[32] !== t19 ? (t20 = /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(Text, { muted: t18, size: 1, weight: "medium", children: t19 }) }), $[31] = t18, $[32] = t19, $[33] = t20) : t20 = $[33];
  let t21;
  $[34] !== t17 || $[35] !== t20 ? (t21 = /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 3, children: [
    t17,
    t20
  ] }), $[34] = t17, $[35] = t20, $[36] = t21) : t21 = $[36];
  let t22;
  $[37] !== t14 || $[38] !== t21 ? (t22 = /* @__PURE__ */ jsx(Card, { as: "label", flex: "none", marginRight: 1, padding: 3, style: t13, tone: t14, children: t21 }), $[37] = t14, $[38] = t21, $[39] = t22) : t22 = $[39];
  let t23;
  $[40] !== t11 || $[41] !== t22 ? (t23 = /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: t11, fallbackPlacements: t12, padding: 1, placement: "bottom", portal: !0, children: t22 }), $[40] = t11, $[41] = t22, $[42] = t23) : t23 = $[42];
  let t24;
  ...
  let t25;
  $[46] !== t24 ? (t25 = /* @__PURE__ */ jsx(Text, { size: 1, children: t24 }), $[46] = t24, $[47] = t25) : t25 = $[47];
  let t26;
  ...
  let t29;
  $[51] !== handleRefresh || $[52] !== t27 || $[53] !== t28 ? (t29 = /* @__PURE__ */ jsx(Button, { "aria-label": t27, fontSize: 1, icon: RefreshIcon, mode: "bleed", loading: t28, onClick: handleRefresh, padding: 2 }), $[51] = handleRefresh, $[52] = t27, $[53] = t28, $[54] = t29) : t29 = $[54];
  let t30;
  $[55] !== t25 || $[56] !== t29 ? (t30 = /* @__PURE__ */ jsx(Box, { padding: 1, children: /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: t25, fallbackPlacements: t26, padding: 2, placement: "bottom", portal: !0, children: t29 }) }), $[55] = t25, $[56] = t29, $[57] = t30) : t30 = $[57];
  let t31;
  $[58] !== openPopup || $[59] !== previewLocationOrigin || $[60] !== previewLocationRoute ? (t31 = /* @__PURE__ */ jsx(Box, { padding: 1, children: /* @__PURE__ */ jsx(OpenPreviewButton, { openPopup, previewLocationOrigin, previewLocationRoute }) }), $[58] = openPopup, $[59] = previewLocationOrigin, $[60] = previewLocationRoute, $[61] = t31) : t31 = $[61];
  let t32;
  $[62] !== onPathChange || $[63] !== previewLocationOrigin || $[64] !== previewLocationRoute || $[65] !== t30 || $[66] !== t31 ? (t32 = /* @__PURE__ */ jsx(Box, { flex: 1, marginX: 1, children: /* @__PURE__ */ jsx(PreviewLocationInput, { prefix: t30, onChange: onPathChange, origin: previewLocationOrigin, suffix: t31, value: previewLocationRoute }) }), $[62] = onPathChange, $[63] = previewLocationOrigin, $[64] = previewLocationRoute, $[65] = t30, $[66] = t31, $[67] = t32) : t32 = $[67];
  ...
  let t37;
  $[71] !== t34 || $[72] !== t35 || $[73] !== t36 ? (t37 = /* @__PURE__ */ jsx(Button, { fontSize: 1, iconRight: ChevronDownIcon, mode: "bleed", padding: 2, space: 2, text: t34, loading: t35, disabled: t36 }), $[71] = t34, $[72] = t35, $[73] = t36, $[74] = t37) : t37 = $[74];
  let t38;
  ...
  let t41;
  $[78] === Symbol.for("react.memo_cache_sentinel") ? (t41 = /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { size: 1, children: createElement(PERSPECTIVE_ICONS.previewDrafts) }) }), $[78] = t41) : t41 = $[78];
  let t42;
  $[79] !== t ? (t42 = t(PERSPECTIVE_TITLE_KEY.previewDrafts), $[79] = t, $[80] = t42) : t42 = $[80];
  let t43;
  $[81] !== t42 ? (t43 = /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: t42 }), $[81] = t42, $[82] = t43) : t43 = $[82];
  let t44;
  $[83] !== t ? (t44 = t("preview-frame.perspective.previewDrafts.text"), $[83] = t, $[84] = t44) : t44 = $[84];
  let t45;
  $[85] !== t44 ? (t45 = /* @__PURE__ */ jsx(Text, { muted: !0, size: 1, children: t44 }), $[85] = t44, $[86] = t45) : t45 = $[86];
  let t46;
  $[87] !== t43 || $[88] !== t45 ? (t46 = /* @__PURE__ */ jsxs(Stack, { flex: 1, space: 2, children: [
    t43,
    t45
  ...
  let t49;
  $[92] === Symbol.for("react.memo_cache_sentinel") ? (t49 = /* @__PURE__ */ jsx(CheckmarkIcon, {}), $[92] = t49) : t49 = $[92];
  let t50;
  $[93] !== t48 ? (t50 = /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { muted: !0, size: 1, style: t48, children: t49 }) }), $[93] = t48, $[94] = t50) : t50 = $[94];
  let t51;
  $[95] !== t46 || $[96] !== t50 ? (t51 = /* @__PURE__ */ jsxs(Flex, { align: "flex-start", gap: 3, children: [
    t41,
    t46,
    t50
  ] }), $[95] = t46, $[96] = t50, $[97] = t51) : t51 = $[97];
  let t52;
  $[98] !== t39 || $[99] !== t40 || $[100] !== t51 ? (t52 = /* @__PURE__ */ jsx(MenuItem, { fontSize: 1, onClick: t39, padding: 3, pressed: t40, tone: PERSPECTIVE_TONES.previewDrafts, children: t51 }), $[98] = t39, $[99] = t40, $[100] = t51, $[101] = t52) : t52 = $[101];
  let t53;
  $[102] !== setPerspective ? (t53 = () => setPerspective("published"), $[102] = setPerspective, $[103] = t53) : t53 = $[103];
  const t54 = perspective === "published";
  let t55;
  $[104] === Symbol.for("react.memo_cache_sentinel") ? (t55 = /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { size: 1, children: createElement(PERSPECTIVE_ICONS.published) }) }), $[104] = t55) : t55 = $[104];
  let t56;
  $[105] !== t ? (t56 = t(PERSPECTIVE_TITLE_KEY.published), $[105] = t, $[106] = t56) : t56 = $[106];
  let t57;
  $[107] !== t56 ? (t57 = /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: t56 }), $[107] = t56, $[108] = t57) : t57 = $[108];
  let t58;
  $[109] !== t ? (t58 = t("preview-frame.perspective.published.text"), $[109] = t, $[110] = t58) : t58 = $[110];
  let t59;
  $[111] !== t58 ? (t59 = /* @__PURE__ */ jsx(Text, { muted: !0, size: 1, children: t58 }), $[111] = t58, $[112] = t59) : t59 = $[112];
  let t60;
  $[113] !== t57 || $[114] !== t59 ? (t60 = /* @__PURE__ */ jsxs(Stack, { flex: 1, space: 2, children: [
    t57,
    t59
  ...
  let t63;
  $[118] === Symbol.for("react.memo_cache_sentinel") ? (t63 = /* @__PURE__ */ jsx(CheckmarkIcon, {}), $[118] = t63) : t63 = $[118];
  let t64;
  $[119] !== t62 ? (t64 = /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { muted: !0, size: 1, style: t62, children: t63 }) }), $[119] = t62, $[120] = t64) : t64 = $[120];
  let t65;
  $[121] !== t60 || $[122] !== t64 ? (t65 = /* @__PURE__ */ jsxs(Flex, { align: "flex-start", gap: 3, children: [
    t55,
    t60,
    t64
  ] }), $[121] = t60, $[122] = t64, $[123] = t65) : t65 = $[123];
  let t66;
  $[124] !== t53 || $[125] !== t54 || $[126] !== t65 ? (t66 = /* @__PURE__ */ jsx(MenuItem, { fontSize: 1, onClick: t53, padding: 3, pressed: t54, tone: PERSPECTIVE_TONES.published, children: t65 }), $[124] = t53, $[125] = t54, $[126] = t65, $[127] = t66) : t66 = $[127];
  let t67;
  $[128] !== t52 || $[129] !== t66 ? (t67 = /* @__PURE__ */ jsxs(Menu, { style: t38, children: [
    t52,
    t66
  ...
  let t69;
  $[132] !== t37 || $[133] !== t67 ? (t69 = /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, padding: 1, children: /* @__PURE__ */ jsx(MenuButton, { button: t37, id: "perspective-menu", menu: t67, popover: t68 }) }), $[132] = t37, $[133] = t67, $[134] = t69) : t69 = $[134];
  ...
  let t72;
  $[138] !== t71 ? (t72 = /* @__PURE__ */ jsx(Text, { size: 1, children: t71 }), $[138] = t71, $[139] = t72) : t72 = $[139];
  let t73;
  ...
  const t75 = viewport === "desktop" ? MobileDeviceIcon : DesktopIcon;
  let t76;
  $[143] !== t74 || $[144] !== t75 || $[145] !== toggleViewportSize ? (t76 = /* @__PURE__ */ jsx(Button, { "aria-label": t74, fontSize: 1, icon: t75, mode: "bleed", onClick: toggleViewportSize, padding: 2 }), $[143] = t74, $[144] = t75, $[145] = toggleViewportSize, $[146] = t76) : t76 = $[146];
  let t77;
  $[147] !== t72 || $[148] !== t76 ? (t77 = /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: t72, fallbackPlacements: t73, padding: 2, placement: "bottom", portal: !0, children: t76 }) }), $[147] = t72, $[148] = t76, $[149] = t77) : t77 = $[149];
  let t78;
  $[150] !== canSharePreviewAccess || $[151] !== canToggleSharePreviewAccess || $[152] !== canUseSharedPreviewAccess || $[153] !== initialUrl || $[154] !== perspective || $[155] !== previewLocationRoute ? (t78 = canSharePreviewAccess && /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, paddingX: 1, children: /* @__PURE__ */ jsx(SharePreviewMenu, { canToggleSharePreviewAccess, canUseSharedPreviewAccess, previewLocationRoute, initialUrl, perspective }) }), $[150] = canSharePreviewAccess, $[151] = canToggleSharePreviewAccess, $[152] = canUseSharedPreviewAccess, $[153] = initialUrl, $[154] = perspective, $[155] = previewLocationRoute, $[156] = t78) : t78 = $[156];
  let t79;
  return $[157] !== t23 || $[158] !== t32 || $[159] !== t5 || $[160] !== t69 || $[161] !== t77 || $[162] !== t78 ? (t79 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t5,
    t23,
    t32,
    t69,
  ...
  const $ = c(6), renderDefault = _temp$3;
  let t0;
  $[0] !== props ? (t0 = props.options?.component ? createElement(props.options.component, {
    ...props,
    renderDefault
  ...
  let t3;
  return $[4] !== header ? (t3 = /* @__PURE__ */ jsx(Card, { flex: "none", padding: 2, borderBottom: !0, style: t1, children: /* @__PURE__ */ jsx(Flex, { align: "center", style: t2, children: header }) }), $[4] = header, $[5] = t3) : t3 = $[5], t3;
};
...
function _temp$3(props_0) {
  return createElement(PreviewHeaderDefault, props_0);
}
const MotionFlex = motion.create(Flex), Preview = memo(forwardRef(function(props, forwardedRef) {
  ...
  const preventIframeInteraction = useMemo(() => (loading || overlaysConnection === "connecting" && iframe.status !== "refreshing") && !continueAnyway, [continueAnyway, iframe.status, loading, overlaysConnection]), canUseViewTransition = useSyncExternalStore(useCallback(() => () => {
  ...
  return useEffect(() => {
    ...
    duration: 0
  } : void 0, children: /* @__PURE__ */ jsxs(TooltipDelayGroupProvider, { delay: 1e3, children: [
    ...
    /* @__PURE__ */ jsx(Card, { flex: 1, tone: "transparent", children: /* @__PURE__ */ jsxs(Flex, { align: "center", height: "fill", justify: "center", padding: (canUseViewTransition ? currentViewport : viewport) === "desktop" ? 0 : 2, sizing: "border", style: {
      ...
      showOverlaysConnectionStatus && !continueAnyway ? /* @__PURE__ */ jsx(MotionFlex, { initial: "initial", animate: "animate", exit: "exit", variants: spinnerVariants, justify: "center", align: "center", style: {
        ...
        timedOut && /* @__PURE__ */ jsx(Button, { disabled: !0, fontSize: 1, mode: "ghost", text: t("preview-frame.continue-button.text"), style: {
          opacity: 0
        } }),
      ...
      /* @__PURE__ */ jsx(IFrame, { animate: iframeAnimations, initial: ["background"], onLoad: onIFrameLoad, preventClick: preventIframeInteraction, ref, src: initialUrl.toString(), style: iframeStyle, variants: iframeVariants })
    ] }) })
  ] }) });
}));
...
function useDocumentsOnPage(perspective, frameStateRef) {
  ...
  const [published, setPublished] = useState({}), [previewDrafts, setPreviewDrafts] = useState({}), urlRef = useRef(""), setDocumentsOnPage = useCallback((key, perspective_0, sourceDocuments = []) => {
...
function useMainDocument(props) {
  ...
  }, t6 = [client, handleResponse, previewUrl, relativeUrl, resolvers], $[9] = client, $[10] = handleResponse, $[11] = previewUrl, $[12] = relativeUrl, $[13] = resolvers, $[14] = t5, $[15] = t6) : (t5 = $[14], t6 = $[15]), useEffect(t5, t6), mainDocumentState;
}
function _temp$2(t0) {
  const [key] = t0;
  return key === "preview";
...
const usePopups = (controller) => {
  const $ = c(10), [popups, setPopups] = useState(_temp$1);
  let t0;
  ...
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t2 = (event) => {
    setStatusMap((prev) => {
      ...
      if (event.status === "disconnected")
        ...
        const hasConnected_0 = next.get(event.connection)?.hasConnected || event.status === "connected", status_2 = event.status === "handshaking" ? "connecting" : event.status;
...
function PresentationTool(props) {
  ...
  const refreshRef = useRef(), handleRefresh = useCallback((fallback) => {
    if (dispatch({
      type: ACTION_IFRAME_REFRESH
...
function PresentationToolGrantsCheck(props) {
  ...
  let t7;
  return $[11] !== props || $[12] !== t4 || $[13] !== t5 || $[14] !== t6 ? (t7 = /* @__PURE__ */ jsx(PresentationTool, { ...props, canCreateUrlPreviewSecrets: t4, canToggleSharePreviewAccess: t5, canUseSharedPreviewAccess: t6 }), $[11] = props, $[12] = t4, $[13] = t5, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
}
