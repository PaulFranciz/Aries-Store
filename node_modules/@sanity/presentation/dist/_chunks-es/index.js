...
function LocationsBanner(props2) {
  ...
  let t4;
  $[14] !== documentId || $[15] !== expanded || $[16] !== isResolving || $[17] !== len || $[18] !== locations || $[19] !== options || $[20] !== presentation?.params || $[21] !== presentationName || $[22] !== schemaType || $[23] !== showPresentationTitle || $[24] !== title || $[25] !== toggle ? (t4 = locations && /* @__PURE__ */ jsxs(Fragment, { children: [
...
function useOpenInStructureAction(props2) {
  ...
  const handleAction = t2, t3 = !presentation || path.length > 0 || !defaultStructureTool, t4 = defaultStructureTool?.icon || MasterDetailIcon, t5 = `Open in ${defaultStructureTool?.title || "Structure"}`;
  let t6;
