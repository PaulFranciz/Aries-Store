"use client";
"use strict";
var require$$0 = require("react"), previewKitCompat = require("@sanity/preview-kit-compat"), context = require("../_chunks-cjs/context.cjs");
function useLiveQuery(initialData, query, queryParams2) {
  const defineStore = require$$0.useContext(context.defineStoreContext), queryParams = previewKitCompat.useQueryParams(queryParams2), store = require$$0.useMemo(
