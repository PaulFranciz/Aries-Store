...
var previewKitCompat = require("@sanity/preview-kit-compat"), require$$0 = require("react"), context = require("./_chunks-cjs/context.cjs");
...
function useLiveQuery(initialData, query, queryParams, options) {
  const { isEqual = isFastEqual } = options || {}, defineStore = require$$0.useContext(context.defineStoreContext), params = previewKitCompat.useQueryParams(queryParams), noStore = require$$0.useMemo(
    () => ({
      subscribe: () => () => {
      },
...
function useIsEnabled() {
  return require$$0.useContext(context.defineStoreContext) !== null;
}
const LiveQueryProvider = require$$0.lazy(
  () => Promise.resolve().then(function() {
    return require("./_chunks-cjs/LiveQueryProvider.cjs");
  })
);
