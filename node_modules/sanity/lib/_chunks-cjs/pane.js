...
`, Pane = React.forwardRef(function(props, forwardedRef) {
  ...
  let t25;
  $[66] !== hidden || $[67] !== id || $[68] !== paneIndex || $[69] !== restProps || $[70] !== style || $[71] !== t19 || $[72] !== t20 || $[73] !== t21 || $[74] !== t22 || $[75] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsxs(Root$9, { "data-testid": "pane", "data-ui": "Pane", tone: "inherit", hidden, id, overflow: t19, ...restProps, "data-pane-collapsed": t20, "data-pane-index": paneIndex, "data-pane-selected": t21, ref: setRef, style, children: [
    t22,
    t24
...
const PaneContent = React.forwardRef(function(props, ref) {
  ...
  let t1;
  return $[6] !== as || $[7] !== children || $[8] !== collapsed || $[9] !== padding || $[10] !== ref || $[11] !== restProps || $[12] !== t0 ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(Root$8, { "data-testid": "pane-content", forwardedAs: as, ...restProps, flex: 1, hidden: collapsed, overflow: t0, padding, ref, tone: "inherit", children }), $[6] = as, $[7] = children, $[8] = collapsed, $[9] = padding, $[10] = ref, $[11] = restProps, $[12] = t0, $[13] = t1) : t1 = $[13], t1;
});
...
function PaneLayout(props) {
  ...
  let t14;
  $[32] !== children || $[33] !== restProps || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(Root$5, { "data-ui": "PaneLayout", ...restProps, "data-collapsed": t11, "data-resizing": t12, "data-mounted": t13, ref: setRootElement, children }), $[32] = children, $[33] = restProps, $[34] = t11, $[35] = t12, $[36] = t13, $[37] = t14) : t14 = $[37];
  let t15;
...
const IntentButton = React.forwardRef(function(props, ref) {
  ...
  const Link = t0;
  let t2;
  return $[6] !== Link || $[7] !== props.disabled || $[8] !== ref || $[9] !== restProps ? (t2 = props.disabled ? /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { ...restProps, as: "a", role: "link", "aria-disabled": "true" }) : /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { ...restProps, as: Link, "data-as": "a", ref }), $[6] = Link, $[7] = props.disabled, $[8] = ref, $[9] = restProps, $[10] = t2) : t2 = $[10], t2;
});
...
}), isLiveEditEnabled = (schemaType) => schemaType.liveEdit === !0, Root$4 = styledComponents.styled(ui.Card)({
  position: "relative",
  zIndex: 1,
  lineHeight: 0
});
function DocumentInspectorHeader(props) {
  ...
  let t5;
  return $[20] !== children || $[21] !== forwardedAs || $[22] !== restProps || $[23] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsxs(Root$4, { ...restProps, as: forwardedAs, children: [
    t4,
    children
...
function Resizable(props) {
  ...
  const [element, setElement] = React.useState(null), elementWidthRef = React.useRef(void 0), [targetWidth, setTargetWidth] = React.useState();
  let t0;
  ...
  let t5;
  return $[18] !== children || $[19] !== forwardedAs || $[20] !== restProps || $[21] !== style || $[22] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsxs(Root$2, { as: forwardedAs, ...restProps, ref: setElement, style, children: [
    children,
    t4
...
const DocumentBox = styledComponents.styled(ui.Box)({
  ...
  const activeViewNode = t4, lastNonDeletedRevId = sanity.useTimelineSelector(timelineStore, _temp$d);
  let t5;
...
const DISABLED_REASON_KEY$1 = {
  ...
  $[3] !== documentStore.pair || $[4] !== duplicate || $[5] !== id || $[6] !== navigateIntent || $[7] !== onComplete || $[8] !== type ? (t2 = async () => {
    ...
    setDuplicating(!0);
    const duplicateSuccess = rxjs.firstValueFrom(documentStore.pair.operationEvents(id, type).pipe(rxjs.filter(_temp$b)));
...
const DocumentStatusBarActionsInner = React.memo(function(props) {
  ...
  const $ = reactCompilerRuntime.c(16), {
    ...
    editState,
    timelineStore
  } = useDocumentPane(), revision = sanity.useTimelineSelector(timelineStore, _temp3$3)?.id || "", disabled = (editState?.draft || editState?.published || {})._rev === revision;
  let t0, t1;
...
function DocumentStatusBar(props) {
  const $ = reactCompilerRuntime.c(21), {
    ...
    title
  } = useDocumentTitle(), CreateLinkedActions = sanity.useSanityCreateConfig().components?.documentLinkedActions, showingRevision = sanity.useTimelineSelector(timelineStore, _temp$8), [collapsed, setCollapsed] = React.useState(null), [rootElement, setRootElement] = React.useState(null);
  let t0;
...
const DocumentPaneProvider = React.memo((props) => {
  const {
    ...
    rev: params.rev,
    since: params.since
  }), onOlderRevision = sanity.useTimelineSelector(timelineStore, (state2) => state2.onOlderRevision), revTime = sanity.useTimelineSelector(timelineStore, (state_0) => state_0.revTime), sinceAttributes = sanity.useTimelineSelector(timelineStore, (state_1) => state_1.sinceAttributes), timelineDisplayed = sanity.useTimelineSelector(timelineStore, (state_2) => state_2.timelineDisplayed), timelineReady = sanity.useTimelineSelector(timelineStore, (state_3) => state_3.timelineReady), isPristine = sanity.useTimelineSelector(timelineStore, (state_4) => state_4.isPristine), isDeleted = React.useMemo(() => timelineReady ? !editState?.draft && !editState?.published && !isPristine : !1, [editState?.draft, editState?.published, isPristine, timelineReady]), previewUrl = usePreviewUrl(value), [presence, setPresence] = React.useState([]);
  React.useEffect(() => {
  ...
  const currentInspector = inspectors2?.find((i) => i.name === inspectorName), resolvedChangesInspector = inspectors2.find((i_0) => i_0.name === HISTORY_INSPECTOR_NAME), changesOpen = currentInspector?.name === HISTORY_INSPECTOR_NAME, {
    t
  } = sanity.useTranslation(structureLocaleNamespace), inspectOpen = params.inspect === "on", compareValue = changesOpen ? sinceAttributes : editState?.published || null, fieldActions = React.useMemo(() => schemaType ? fieldActionsResolver({
    documentId,
    documentType,
    schemaType
  ...
  }, [editState.draft, editState.published, initialValue.value, patch, telemetry2]);
  ...
  }, [isPermissionsLoading, permissions?.granted, schemaType, isNonExistent, connectionState, editState.transactionSyncLock?.enabled, editState.draft, liveEdit, ready, revTime, isDeleting, isDeleted, isCreateLinked]), formState = sanity.useFormState({
    schemaType,
...
function DocumentPaneInner(props) {
  ...
  let t12;
  return $[49] !== providerProps || $[50] !== t11 || $[51] !== t8 ? (t12 = /* @__PURE__ */ jsxRuntime.jsx(DocumentPaneProvider, { ...providerProps, children: t11 }, t8), $[49] = providerProps, $[50] = t11, $[51] = t8, $[52] = t12) : t12 = $[52], t12;
}
function _temp$5(t0) {
  const {
    children
