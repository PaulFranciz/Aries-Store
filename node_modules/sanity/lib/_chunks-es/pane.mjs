...
function PaneLayout(props) {
  ...
  let t14;
  $[32] !== children || $[33] !== restProps || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 ? (t14 = /* @__PURE__ */ jsx(Root$5, { "data-ui": "PaneLayout", ...restProps, "data-collapsed": t11, "data-resizing": t12, "data-mounted": t13, ref: setRootElement, children }), $[32] = children, $[33] = restProps, $[34] = t11, $[35] = t12, $[36] = t13, $[37] = t14) : t14 = $[37];
  let t15;
...
function Resizable(props) {
  ...
  const [element, setElement] = useState(null), elementWidthRef = useRef(void 0), [targetWidth, setTargetWidth] = useState();
  let t0;
...
function DocumentStatusBar(props) {
  const $ = c(21), {
    ...
    title
  } = useDocumentTitle(), CreateLinkedActions = useSanityCreateConfig().components?.documentLinkedActions, showingRevision = useTimelineSelector(timelineStore, _temp$8), [collapsed, setCollapsed] = useState(null), [rootElement, setRootElement] = useState(null);
  let t0;
