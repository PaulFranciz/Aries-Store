...
"[project]/node_modules/@codemirror/view/dist/index.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class WidgetView extends ContentView {
    ...
    get overrideDOMText() {
        if (this.length == 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty;
        let top = this;
        while(top.parent)top = top.parent;
        let { view } = top, text = view && view.state.doc, start = this.posAtStart;
        return text ? text.slice(start, start + this.length) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty;
    }
    domAtPos(pos) {
...
class WidgetBufferView extends ContentView {
    ...
    get overrideDOMText() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty;
    }
    get isHidden() {
        return true;
    }
...
@nonabstract
*/ class Decoration extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeValue"] {
    constructor(/**
    @internal
    */ startSide, /**
    @internal
    ...
    */ static set(of, sort = false) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].of(of, sort);
    }
    /**
    @internal
    */ hasHeight() {
...
*/ Decoration.none = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].empty;
...
LineDecoration.prototype.mapMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MapMode"].TrackBefore;
...
class PointDecoration extends Decoration {
    constructor(spec, startSide, endSide, block, widget, isReplace){
        ...
        this.mapMode = !block ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MapMode"].TrackDel : startSide <= 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MapMode"].TrackBefore : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MapMode"].TrackAfter;
    }
...
class BlockWidgetView extends ContentView {
    ...
    get overrideDOMText() {
        return this.parent ? this.parent.view.state.doc.slice(this.posAtStart, this.posAtEnd) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty;
    }
    domBoundsAround() {
        return null;
    }
...
class ContentBuilder {
    ...
    static build(text, from, to, decorations, dynamicDecorationMap) {
        ...
        builder.openEnd = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].spans(decorations, from, to, builder);
...
function moveVisually(line, order, dir, start, forward) {
    ...
    let nextIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findClusterBreak"])(line.text, startIndex, span.forward(forward, dir));
    if (nextIndex < span.from || nextIndex > span.to) nextIndex = spanEnd;
    movedOver = line.text.slice(Math.min(startIndex, nextIndex), Math.max(startIndex, nextIndex));
    let nextSpan = spanI == (forward ? order.length - 1 : 0) ? null : order[spanI + (forward ? 1 : -1)];
    if (nextSpan && nextIndex == spanEnd && nextSpan.level + (forward ? 0 : 1) < span.level) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(nextSpan.side(!forward, dir) + line.from, nextSpan.forward(forward, dir) ? 1 : -1, nextSpan.level);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(nextIndex + line.from, span.forward(forward, dir) ? -1 : 1, span.level);
}
...
const clickAddsSelectionRange = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const dragMovesSelection$1 = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const mouseSelectionStyle = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const exceptionSink = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const updateListener = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const inputHandler = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const focusChangeEffect = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const clipboardInputFilter = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const clipboardOutputFilter = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const perLineTextDirection = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine: (values)=>values.some((x)=>x)
});
const nativeSelectionHidden = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine: (values)=>values.some((x)=>x)
});
const scrollHandler = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
class ScrollTarget {
    ...
    clip(state) {
        return this.range.to <= state.doc.length ? this : new ScrollTarget(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(state.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
    }
}
const scrollIntoView = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].define({
    map: (t, ch)=>t.map(ch)
});
const setEditContextFormatting = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].define();
/**
...
const editable = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine: (values)=>values.length ? values[0] : true
});
let nextPluginID = 0;
const viewPlugin = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
/**
...
const editorAttributes = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const contentAttributes = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
// Provide decorations
const decorations = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const outerDecorations = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const atomicRanges = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const bidiIsolatedRanges = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
function getIsolatedRanges(view, line) {
    let isolates = view.state.facet(bidiIsolatedRanges);
    if (!isolates.length) return isolates;
    let sets = isolates.map((i)=>i instanceof Function ? i(view) : i);
    let result = [];
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].spans(sets, line.from, line.to, {
        point () {},
...
const scrollMargins = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
...
const styleModule = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
class ChangedRange {
...
*/ class ViewUpdate {
    ...
    */ transactions){
        ...
        */ this.flags = 0;
        ...
        this.changes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ChangeSet"].empty(this.startState.doc.length);
...
class DocView extends ContentView {
    ...
    coordsForChar(pos) {
        ...
        let end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findClusterBreak"])(child.text, off);
    ...
    updateDeco() {
        ...
        if (outerDeco.length) {
            ...
            allDeco.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].join(outerDeco));
        }
        this.decorations = [
...
function findChangedDeco(a, b, diff) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].compare(a, b, diff, comp);
    return comp.changes;
}
...
function groupAt(state, pos, bias = 1) {
    ...
    if (line.length == 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos);
    if (linePos == 0) bias = 1;
    else if (linePos == line.length) bias = -1;
    let from = linePos, to = linePos;
    if (bias < 0) from = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findClusterBreak"])(line.text, linePos, false);
    else to = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findClusterBreak"])(line.text, linePos);
    let cat = categorize(line.text.slice(from, to));
    while(from > 0){
        let prev = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findClusterBreak"])(line.text, from, false);
        if (categorize(line.text.slice(prev, from)) != cat) break;
        from = prev;
    }
    while(to < line.length){
        let next = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findClusterBreak"])(line.text, to);
        if (categorize(line.text.slice(to, next)) != cat) break;
        to = next;
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(from + line.from, to + line.from);
}
...
function posAtCoordsImprecise(view, contentRect, block, x, y) {
    ...
    return block.from + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findColumn"])(content, into, view.state.tabSize);
}
...
function moveToLineBoundary(view, start, forward, includeWrap) {
    ...
    if (coords) {
        ...
        if (pos != null) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos, forward ? -1 : 1);
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(forward ? line.to : line.from, forward ? -1 : 1);
}
...
function moveVertically(view, start, forward, distance) {
    ...
    if (startPos == (forward ? view.state.doc.length : 0)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(startPos, start.assoc);
    ...
    for(let extra = 0;; extra += 10){
        ...
        if (curY < rect.top || curY > rect.bottom || (dir < 0 ? pos < startPos : pos > startPos)) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos, assoc, undefined, goal);
        }
    }
}
...
function skipAtoms(view, oldPos, pos) {
    ...
    return newPos == pos.from ? pos : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(newPos, newPos < pos.from ? 1 : -1);
}
...
class DOMReader {
    constructor(points, state){
        this.points = points;
        this.text = "";
        this.lineSeparator = state.facet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorState"].lineSeparator);
    }
    append(text) {
        this.text += text;
    }
...
class DOMChange {
    constructor(view, start, end, typeOver){
        ...
        if (view.state.readOnly && start > -1) {
            ...
            this.newSel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].single(anchor, head);
        }
    }
}
function applyDOMChange(view, domChange) {
    ...
    if (domChange.bounds) {
        ...
        if (diff) {
            ...
            change = {
                from: from + diff.from,
                to: from + diff.toA,
                insert: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].of(domChange.text.slice(diff.from, diff.toB).split(LineBreakPlaceholder))
            };
        }
    ...
    if (!change && domChange.typeOver && !sel.empty && newSel && newSel.main.empty) {
        ...
        if (newSel && change.insert.length == 2) newSel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].single(newSel.main.anchor - 1, newSel.main.head - 1);
        change = {
            from: change.from,
            to: change.to,
        ...
        if (newSel) newSel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].single(newSel.main.anchor - 1, newSel.main.head - 1);
        change = {
            from: sel.from,
            to: sel.to,
            insert: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].of([
        ...
        if (startState.selection.ranges.length > 1 && view.inputState.composing >= 0 && change.to <= sel.to && change.to >= sel.to - 10) {
            ...
            tr = startState.changeByRange((range)=>{
                ...
                return {
                    ...
                    range: !mainSel ? range.map(rangeChanges) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(Math.max(0, mainSel.anchor + selOff), Math.max(0, mainSel.head + selOff))
                };
            });
        } else {
            tr = {
...
function selectionFromPoints(points, base) {
    ...
    return anchor > -1 && head > -1 ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].single(anchor + base, head + base) : null;
}
class InputState {
...
class MouseSelection {
    constructor(view, startEvent, style, mustSelect){
        ...
        this.multiple = view.state.facet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorState"].allowMultipleSelections) && addsSelectionRange(view, startEvent);
    ...
    skipAtoms(sel) {
        ...
        for(let i = 0; i < sel.ranges.length; i++){
            ...
            if (range.empty) {
                ...
                if (pos != range.from) updated = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos, -1);
            } else {
                let from = skipAtomicRanges(this.atoms, range.from, -1);
                let to = skipAtomicRanges(this.atoms, range.to, 1);
                if (from != range.from || to != range.to) updated = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(range.from == range.anchor ? from : to, range.from == range.head ? from : to);
            }
            if (updated) {
        ...
        return ranges ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].create(ranges, sel.mainIndex) : sel;
    }
    select(event) {
    ...
    if (linewise) {
        ...
        changes = state.changeByRange((range)=>{
            ...
            return {
                ...
                range: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(range.from + insert.length)
            };
        });
    } else if (byLine) {
        changes = state.changeByRange((range)=>{
            ...
            return {
                ...
                range: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(range.from + line.length)
            };
        });
    } else {
...
function rangeForClick(view, pos, bias, type) {
    if (type == 1) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos, bias);
    } else if (type == 2) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(from, to);
    }
}
    ...
    return {
        ...
        get (event, extend, multiple) {
            ...
            if (start.pos != cur.pos && !extend) {
                ...
                range = from < range.from ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(from, to) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(to, from);
            }
            ...
            else return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].create([
                range
            ]);
        }
    };
...
function removeRangeAround(sel, pos) {
    for(let i = 0; i < sel.ranges.length; i++){
        ...
        if (from <= pos && to >= pos) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].create(sel.ranges.slice(0, i).concat(sel.ranges.slice(i + 1)), sel.mainIndex == i ? 0 : sel.mainIndex - (sel.mainIndex > i ? 1 : 0));
    }
    return null;
}
handlers.dragstart = (view, event)=>{
    ...
    if (event.target.draggable) {
        ...
        if (cView && cView.isWidget) {
            ...
            if (from >= range.to || to <= range.from) range = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(from, to);
        }
    }
    let { inputState } = view;
...
const isFocusChange = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Annotation"].define();
...
class HeightOracle {
    constructor(lineWrapping){
        ...
        this.doc = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty;
        this.heightSamples = {};
...
class NodeBuilder {
    ...
    static build(oracle, decorations, from, to) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].spans(decorations, from, to, builder, 0);
        return builder.finish(from);
    }
}
function heightRelevantDecoChanges(a, b, diff) {
    let comp = new DecorationComparator;
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].compare(a, b, diff, comp, 0);
    return comp.changes;
}
...
class ViewState {
    constructor(state){
        ...
        this.heightMap = HeightMap.empty().applyChanges(this.stateDeco, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty, this.heightOracle.setDoc(state.doc), [
    ...
    measure(view) {
        ...
        if (measureContent) {
            ...
            for (let vp of this.viewports){
                ...
                this.heightMap = (refresh ? HeightMap.empty().applyChanges(this.stateDeco, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty, this.heightOracle, [
                    new ChangedRange(0, 0, 0, view.state.doc.length)
        ...
        let addGap = (from, to, line, structure)=>{
            ...
            if (!gap) {
                ...
                if (to < line.to && mayMeasure && wrapping && mayMeasure.visibleRanges.some((r)=>r.from <= to && r.to >= to)) {
                    let lineStart = mayMeasure.moveToLineBoundary(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(to), false, true).head;
    ...
    computeVisibleRanges(changes) {
        ...
        let ranges = [];
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].spans(deco, this.viewport.from, this.viewport.to, {
            span (from, to) {
                ranges.push({
                    from,
                    to
...
function lineStructure(from, to, stateDeco) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].spans(stateDeco, from, to, {
        span () {},
        point (from, to) {
            if (from > pos) {
                ranges.push({
...
const theme = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine: (strs)=>strs.join(" ")
});
const darkTheme = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine: (values)=>values.indexOf(true) > -1
});
const baseThemeID = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$style$2d$mod$2f$src$2f$style$2d$mod$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StyleModule"].newName(), baseLightID = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$style$2d$mod$2f$src$2f$style$2d$mod$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StyleModule"].newName(), baseDarkID = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$style$2d$mod$2f$src$2f$style$2d$mod$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StyleModule"].newName();
const lightDarkIDs = {
    "&light": "." + baseLightID,
    "&dark": "." + baseDarkID
};
function buildTheme(main, spec, scopes) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$style$2d$mod$2f$src$2f$style$2d$mod$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StyleModule"](spec, {
        finish (sel) {
    ...
    constructor(view){
        ...
        this.handlers.textupdate = (e)=>{
            ...
            let change = {
                from,
                to,
                insert: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].of(e.text.split("\n"))
            };
            ...
            if (change.from == change.to && !change.insert.length) {
                let newSel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].single(this.toEditorPos(e.selectionStart), this.toEditorPos(e.selectionEnd));
            ...
            if (!view.state.readOnly) {
                ...
                applyDOMChangeInner(view, change, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].single(this.toEditorPos(e.selectionStart, newLen), this.toEditorPos(e.selectionEnd, newLen)));
            }
...
*/ class EditorView {
    ...
    */ constructor(config = {}){
        ...
        */ this.measureRequests = [];
        ...
        this.viewState = new ViewState(config.state || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorState"].create(config));
    ...
    dispatch(...input) {
        let trs = input.length == 1 && input[0] instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Transaction"] ? input : input.length == 1 && Array.isArray(input[0]) ? input[0] : [
    ...
    */ update(transactions) {
        ...
        if (state.facet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorState"].phrases) != this.state.facet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorState"].phrases)) return this.setState(state);
        ...
        try {
            ...
            for (let tr of transactions){
                ...
                if (tr.scrollIntoView) {
                    ...
                    scrollTarget = new ScrollTarget(main.empty ? main : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(main.head, main.head > main.anchor ? -1 : 1));
                }
    ...
    */ get themeClasses() {
    ...
    mountStyles() {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$style$2d$mod$2f$src$2f$style$2d$mod$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StyleModule"].mount(this.root, this.styleModules.concat(baseTheme$1).reverse(), nonce ? {
            nonce
        } : undefined);
    }
    readMeasured() {
    ...
    */ visualLineSide(line, end) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(span.side(end, dir) + line.from, span.forward(!end, dir) ? 1 : -1);
    }
    /**
    ...
    */ static scrollIntoView(pos, options = {}) {
        return scrollIntoView.of(new ScrollTarget(typeof pos == "number" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos) : pos, options.y, options.x, options.yMargin, options.xMargin));
    }
    /**
    ...
    */ scrollSnapshot() {
        ...
        return scrollIntoView.of(new ScrollTarget(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(ref.from), "start", "start", ref.top - scrollTop, scrollLeft, true));
    }
    /**
    ...
    */ static theme(spec, options) {
        let prefix = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$style$2d$mod$2f$src$2f$style$2d$mod$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StyleModule"].newName();
        let result = [
            theme.of(prefix),
    ...
    */ static baseTheme(spec) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Prec"].lowest(styleModule.of(buildTheme("." + baseThemeID, spec, lightDarkIDs)));
    }
    /**
...
*/ EditorView.cspNonce = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
...
search match).
*/ EditorView.announce = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].define();
...
const handleKeyEvents = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Prec"].default(/*@__PURE__*/ EditorView.domEventHandlers({
    keydown (event, view) {
...
*/ const keymap = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
...
function runHandlers(map, event, view, scope) {
    ...
    let name = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$w3c$2d$keyname$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["keyName"])(event);
    let charCode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["codePointAt"])(name, 0), isChar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["codePointSize"])(charCode) == name.length && name != " ";
    ...
    if (scopeObj) {
        ...
        !(browser.windows && event.ctrlKey && event.altKey) && (baseName = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$w3c$2d$keyname$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["base"][event.keyCode]) && baseName != name) {
            if (runFor(scopeObj[prefix + modifiers(baseName, event, true)])) {
                handled = true;
            } else if (event.shiftKey && (shiftName = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$w3c$2d$keyname$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["shift"][event.keyCode]) != name && shiftName != baseName && runFor(scopeObj[prefix + modifiers(shiftName, event, false)])) {
                handled = true;
            }
...
const layerOrder = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
/**
Define a layer.
...
const selectionConfig = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine (configs) {
    ...
    markers (view) {
        ...
        for (let r of state.selection.ranges){
            ...
            if (r.empty ? !prim || CanHidePrimary : conf.drawRangeCursor) {
                ...
                let cursor = r.empty ? r : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(r.head, r.head > r.anchor ? -1 : 1);
...
const hideNativeSelection = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Prec"].highest(/*@__PURE__*/ EditorView.theme(themeSpec));
const setDropCursorPos = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].define({
    map (pos, mapping) {
        return pos == null ? null : mapping.mapPos(pos);
    }
});
const dropCursorPos = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateField"].define({
    create () {
        return null;
    },
    update (pos, tr) {
...
*/ class MatchDecorator {
    ...
    */ constructor(config){
    ...
    plugin.
    */ createDeco(view) {
        let build = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSetBuilder"](), add = build.add.bind(build);
...
const specialCharConfig = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine (configs) {
        let config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["combineConfig"])(configs, {
            render: null,
        ...
        makeDecorator(conf) {
            return new MatchDecorator({
                ...
                decoration: (m, view, pos)=>{
                    let { doc } = view.state;
                    let code = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["codePointAt"])(m[0], 0);
                    if (code == 9) {
                        let line = doc.lineAt(pos);
                        let size = view.state.tabSize, col = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["countColumn"])(line.text, size, pos - line.from);
                        return Decoration.replace({
...
function rectangleFor(state, a, b) {
    ...
    if (a.off > MaxOff || b.off > MaxOff || a.col < 0 || b.col < 0) {
        ...
        for(let i = startLine; i <= endLine; i++){
            ...
            if (line.length <= endOff) ranges.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(line.from + startOff, line.to + endOff));
        }
    } else {
        let startCol = Math.min(a.col, b.col), endCol = Math.max(a.col, b.col);
        for(let i = startLine; i <= endLine; i++){
            let line = state.doc.line(i);
            let start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findColumn"])(line.text, startCol, state.tabSize, true);
            if (start < 0) {
                ranges.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(line.to));
            } else {
                let end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findColumn"])(line.text, endCol, state.tabSize);
                ranges.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(line.from + start, line.from + end));
            }
        }
    }
    return ranges;
...
function getPos(view, event) {
    ...
    let col = off > MaxOff ? -1 : off == line.length ? absoluteColumn(view, event.clientX) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["countColumn"])(line.text, view.state.tabSize, offset - line.from);
    return {
        line: line.number,
        col,
        off
...
function rectangleSelectionStyle(view, event) {
    ...
    return {
        ...
        get (event, _extend, multiple) {
            ...
            if (multiple) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].create(ranges.concat(startSel.ranges));
            else return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].create(ranges);
        }
    };
}
/**
...
const tooltipConfig = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine: (values)=>{
        var _a, _b, _c;
        return {
...
*/ const showTooltip = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    enables: [
        tooltipPlugin,
        baseTheme
    ]
});
const showHoverTooltip = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
...
*/ function hoverTooltip(source, options = {}) {
    let setHover = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].define();
    let hoverState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateField"].define({
        create () {
            return [];
        },
        update (value, tr) {
            if (value.length) {
                ...
                if (tr.docChanged) {
                    ...
                    for (let tooltip of value){
                        let newPos = tr.changes.mapPos(tooltip.pos, -1, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MapMode"].TrackDel);
                        if (newPos != null) {
...
const closeHoverTooltipEffect = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].define();
/**
...
const panelConfig = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine (configs) {
...
*/ const showPanel = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    enables: panelPlugin
});
/**
...
class.
*/ class GutterMarker extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeValue"] {
    /**
    @internal
    */ compare(other) {
        return this == other || this.constructor == other.constructor && this.eq(other);
...
GutterMarker.prototype.mapMode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MapMode"].TrackBefore;
...
*/ const gutterLineClass = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
/**
Facet used to add a class to all gutter elements next to a widget.
Should not provide widgets with a `toDOM` method.
*/ const gutterWidgetClass = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const defaults = {
    class: "",
    renderEmptyElements: false,
    elementStyle: "",
    markers: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].empty,
    lineMarker: ()=>null,
    widgetMarker: ()=>null,
...
const activeGutters = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
/**
...
const unfixGutters = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine: (values)=>values.some((x)=>x)
});
/**
...
const gutterView = /*@__PURE__*/ ViewPlugin.fromClass(class {
    ...
    syncGutters(detach) {
        ...
        let lineClasses = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].iter(this.view.state.facet(gutterLineClass), this.view.viewport.from);
        let classSet = [];
...
class UpdateContext {
    constructor(gutter, viewport, height){
        ...
        this.height = height;
        this.i = 0;
        this.cursor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].iter(gutter.markers, viewport.from);
    }
...
class SingleGutterView {
    ...
    update(update) {
        ...
        return !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].eq(this.markers, prevMarkers, vp.from, vp.to) || (this.config.lineMarkerChange ? this.config.lineMarkerChange(update) : false);
    }
    destroy() {
...
*/ const lineNumberMarkers = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
/**
Facet used to create markers in the line number gutter next to widgets.
*/ const lineNumberWidgetMarker = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
const lineNumberConfig = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define({
    combine (values) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["combineConfig"])(values, {
            formatNumber: String,
            domEventHandlers: {}
        }, {
...
const activeLineGutterHighlighter = /*@__PURE__*/ gutterLineClass.compute([
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].of(marks);
});
/**
...
//# sourceMappingURL=node_modules_%40codemirror_view_dist_index_378973.js.map